    ...
    public sealed class LocalePT_PT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.UseOverlapWarningColor)), "<Activado Ã© recomendado>\nMantÃ©m visÃ­vel o contorno vanilla vermelho-salmÃ£o do jogo quando a colocaÃ§Ã£o de objectos ou redes Ã© bloqueada por itens sobrepostos.\nLimites de Ã¡rea, como guias de raio de quintas da IndÃºstria Especializada, ficam intactos.\n\nFunciona com todos os modos Bulldozer + estradas e nÃ£o substitui a tua cor personalizada guardada." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.UseCustomColorsForNetLanes)), "<Activado Ã© recomendado>\nUsa a tua cor/transparÃªncia HC guardada ao colocar itens de detalhe NetLane, como vedaÃ§Ãµes, sebes, marcaÃ§Ãµes e ferramentas semelhantes baseadas em faixas.\n\n- Estradas normais continuam a seguir a opÃ§Ã£o Bulldozer + estradas escolhida na lista.\n- Desactiva se quiseres que essas ferramentas usem o azul vanilla do jogo.\n- A cor de erro de sobreposiÃ§Ã£o continua a ter prioridade quando activada (cor de erro vanilla = vermelho-salmÃ£o)." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.MochiDedicationText)), "Este mod Ã© dedicado Ã  Mochi. Ela foi uma cadelinha muito amada, adoptada aos 7 anos,\ne deu 13 anos de amor e alegria. Este mod nÃ£o seria possÃ­vel sem a Mochi." },
            };
        }
