    ...
    public sealed class LocaleZH_HANT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.TogglePanelBinding)), "用於開啟 / 關閉城市內 Hover 物件顏色面板的快捷鍵。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.ToggleSurfaceToolAreasBinding)), "放置 Surface 時，用快捷鍵隱藏或恢復目前 Surface 工具邊界預覽線。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.TogglePresetBinding)), "用於在預設槽 1 和槽 2 之間切換的快捷鍵。" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(HoverColorsSettings.MochiDedicationText)), "謹以此紀念 Mochi。" },
                { m_Settings.GetOptionDescLocaleID(nameof(HoverColorsSettings.MochiDedicationText)), "此模組獻給 Mochi。她是一隻深受喜愛的狗狗，7 歲時被領養，\n帶來了 13 年的愛與快樂。沒有 Mochi，就不會有這個模組。" },
            };
        }
