...
#   and UTF-8 BOM in tracked repo text files that are supposed to be LF.
#
...
#   - Non-empty files without a trailing LF get one appended, matching this
#     repo's .editorconfig (insert_final_newline = true).
#
# Usage:
...
# "types" skips UI/types/*.d.ts — ambient declarations regenerated by
# `npx create-csii-ui-mod update`, not hand-written source.
SKIP_PARTS = {
    ".git",
    ".vs",
    "bin",
...
def main() -> int:
    ...
    for relative_path in tracked_files:
        ...
        new_data = ensure_final_newline(new_data)
